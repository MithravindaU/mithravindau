...
## 🎬 Cinematch AI
Movie recommendation system using intelligent similarity matching.

## ❤️ CardioSense AI
Heart disease prediction using machine learning.

## 🐶 PawVision CNN
Deep learning image classifier for cats and dogs.
